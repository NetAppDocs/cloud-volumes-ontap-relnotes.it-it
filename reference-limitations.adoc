...
== Gli aggiornamenti software devono essere completati tramite NetApp Console
...
Le modifiche apportate alla configurazione di Cloud Volumes ONTAP dalla console del provider cloud determinano una configurazione non supportata. Qualsiasi modifica alle risorse Cloud Volumes ONTAP create e gestite dalla Console può influire sulla stabilità del sistema e sulla capacità della Console di gestire il sistema.
