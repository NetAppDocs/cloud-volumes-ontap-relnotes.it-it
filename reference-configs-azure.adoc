...
. ^6^ Per informazioni sui dischi interni per i dati di sistema per le distribuzioni HA con zone di disponibilità singole e multiple, fare riferimento a https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/reference-default-configs.html#azure-ha-pair["Azure (coppia ha)"^] .
