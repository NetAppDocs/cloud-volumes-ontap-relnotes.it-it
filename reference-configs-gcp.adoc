...
A partire da Cloud Volumes ONTAP 9.13.0, _Flash cache_, velocità di scrittura elevata e MTU (Maximum Transmission Unit) superiore di 8.896 byte, sono disponibili per le seguenti istanze di implementazione ha Pair: * n2-standard-16 * n2-standard-32 * n2-standard-48 * n2-standard-64
