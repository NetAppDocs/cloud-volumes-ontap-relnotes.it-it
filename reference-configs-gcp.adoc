...
Nelle implementazioni a nodo singolo, a partire da Cloud Volumes ONTAP 9.18.1, se si selezionano le varianti LSSD (Local SSD) delle VM C3, Flash Cache viene abilitato per impostazione predefinita. Non è possibile passare tra le varianti di VM C3 LSSD nell'implementazione di Cloud Volumes ONTAP, anche se la variante di destinazione supporta Flash Cache.
